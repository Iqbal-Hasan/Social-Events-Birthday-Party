...
const Signup = () => {
  ...
  return (
    <div>
      <div className="customFont lg:w-[1000px]  my-20 px-5 lg:px-10 py-10 rounded-lg lg:shadow-2xl border-2 border-gray-300 xl:max-w-screen-xl lg:mx-auto grid lg:grid-cols-2 gap-5 lg:gap-10 items-center">
        ...
        >
          ...
          <div
            onClick={googleLogin}
            className="cursor-pointer flex items-center gap-2 p-4 rounded-lg mx-auto border border-slate-400 w-fit"
          >
            <img
              className="w-[30px]"
          ...
          <div className="flex flex-col gap-3">
            <input
              ...
              className="border-2 border-gray-500 py-4 px-4 rounded-lg text-lg focus:outline-none"
              required
            />
            <input
            ...
            <div className="flex flex-col">
              <input
                ...
                } border-2 border-gray-500 py-4 px-4 rounded-lg text-lg focus:outline-none`}
                type="email"
            ...
            <div className="relative">
              <input
                ...
                } border-2 w-full border-gray-500 py-4 px-4 rounded-lg text-lg focus:outline-none`}

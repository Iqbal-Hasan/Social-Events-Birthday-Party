...
export default function Price() {
  return (
    <div className="flex flex-col items-center">
      <h1 className="text-center text-5xl font-bold mb-5 mt-20">Price</h1>
      <p className="text-center text-base sm:text-lg md:text:xl mb-10">
        Best Price For You (One Price Option)
      </p>
      <Card
        color="gray"
        variant="gradient"
        className=" mx-5 max-w-[20rem] p-8 mb-20"
      >
        <CardHeader
          floated={false}
          shadow={false}
        ...
        <CardBody className="p-0">
          <ul className="flex flex-col gap-4">
            ...
            <li className="flex items-center gap-4">
              ...
              <Typography className="font-normal">High quality cake</Typography>
            </li>
            <li className="flex items-center gap-4">
              <span className="rounded-full border border-white/20 bg-white/20 p-1">
                <CheckIcon />

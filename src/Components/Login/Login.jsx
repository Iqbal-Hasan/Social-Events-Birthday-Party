...
const Login = () => {
  ...
  return (
    <>
      <div className="customFont lg:w-[1000px]  my-20 px-5 lg:px-10 py-10 rounded-lg lg:shadow-2xl border-t-2 border-gray-300 xl:max-w-screen-xl lg:mx-auto grid lg:grid-cols-2 gap-5 lg:gap-10 items-center">
